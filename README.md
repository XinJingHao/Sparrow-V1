...
The number of vectorized environments of Sparrow-V1.1 is exactly equal to the number of maps in `params.map_address`. You can easily create more vectorized environments by just copying more `map.png` files.
